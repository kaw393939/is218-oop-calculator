...
[Read the lesson](../../docs/lessons/04-repl.md). This folder contains worked source for one intermediate checkpoint.
...
| [entrypoint.py](entrypoint.py) | `calculator/__main__.py` |

Run `python -m pytest`: the unextended reference has **15 passing tests**. Then run `python -m calculator` and follow the lesson conversation.
